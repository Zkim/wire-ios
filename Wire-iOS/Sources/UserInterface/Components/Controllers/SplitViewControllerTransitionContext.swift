...
final class SplitViewControllerTransitionContext: NSObject, UIViewControllerContextTransitioning {
    ...
    init(fromViewController: UIViewController?, to toViewController: UIViewController?, containerView: UIView?) {
        super.init()
    ...
    func view(for key: UITransitionContextViewControllerKey) -> UIView? {
